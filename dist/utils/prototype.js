...
Date.prototype.format = function (f) {
  ...
  let d = this;
  return f.replace(/(yyyy|yy|MM|M|dd|KS|KL|ES|EL|HH|hh|mm|ss|a\/p|am\/pm|week)/gi, function ($1) {
    switch ($1) {
      case 'yyyy':
      ...
      // hours (24hours, 2letters)
      case 'hh':
        return (d.getHours() > 12 ? d.getHours() - 12 : d.getHours()).zf(2);
      // hours (12hours, 2letters)
      case 'mm':
